...
<style>
    ...
    * {
    ...
    .pymnt-cntnt div.sctn-row div.sctn-col.cvv {
        background-image: url("form_tarjeta/cvv.png");
    ...
    .openpay div.logo {
        background-image: url("form_tarjeta/openpay.png");
    ...
    .openpay div.shield {
        background-image: url("form_tarjeta/security.png");
        background-position: left bottom;
        background-repeat: no-repeat;
        font-size: 12px;
        font-weight: 400;
    ...
    .card-expl div.debit {
        background-image: url("form_tarjeta/cards2.png");
        margin-left: 20px;
        width: 540px;
    }
    .card-expl div.credit {
        background-image: url("form_tarjeta/cards1.png");
        border-right: 1px solid #ccc;
        margin-left: 30px;
        width: 209px;
    }
    ...
    <div class="bkng-tb-cntnt">
        <div class="pymnts">
            <form action="pay.php" method="POST" id="payment-form">
                ...
                <input type="hidden" name="last_name" value="<?php echo $row['apellido'];?>">
                <input type="hidden" name="name" value="<?php echo $row['nombre_cliente'];?>">
                <input type="hidden" name="phone_number" value="<?php echo $row['telefono'];?>">
