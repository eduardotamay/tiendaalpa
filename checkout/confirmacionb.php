...
if(isset($_SESSION['nombre_cliente'])){
    ...
    $objPedido = new Pedido();
        $resultPedido = $objPedido->buscar_pedido_cliente($id_cliente);
        ...
        <div class="row" style="margin-top:20px; margin-bottom:80px;color:#666;">
                    ...
                    <div class="row">
                        <div class="col-md-7" id="productos-box" style="">
                            ...
                            <div class="row fila-producto">
                                ...
                                <div class="col-4 my-auto col-subtotal">$<?php echo $row['subtotal_producto'];?></div>
                            </div>
                            <hr>
                            <?php } ?>
                        </div>
            ...
            <div class="col-md-4">
                <div class="caja-blanca sticky-top" style="top:100px;">
                    ...
                    <div style="font-weight: bolder;background-color: #eee; border-radius: 5px;width:80%; padding:10px;font-size:1.2rem;color:black;text-align:center;margin:15px auto;">93000442616874</div>
                    ...
                    <div class="row" style="padding-top:15px;padding-bottom: 15px; font-weight: bolder;">
                        ...
                        <div class="col-5 derecha">$<?php echo $rowPedido['subtotal'];?></div>
                        <div class="col-1"></div>
                    </div>
                    <div class="row" style="padding-top:15px;padding-bottom: 15px;font-weight: bolder;">
                        <div class="col-1"></div>
