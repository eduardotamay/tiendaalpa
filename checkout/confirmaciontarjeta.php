...
// Capturar el orden de la compra
...
// ord_2oAkb4Yqx4GZR43cx
// Imprimir ejemplo
// var_dump($order->tax_lines);
// echo "Id #".$order->id;
        ...
        <div class="row" style="margin-top:20px; margin-bottom:80px;color:#666;">
            ...
            <div class="col-md-4">
                <div class="caja-blanca sticky-top" style="top:100px;">
                    <div class="row">
                        <div class="col" style="color:green;font-size:1rem;font-weight: bold;text-align: center;">Pago confirmado</div>
                    </div>
                    <hr>
                    <div class="row" style="margin-bottom:20px;">
                    <?php
                        if ($order->charges[0]->payment_method->type=='credit') {
                            echo '<div class="col-6" style="color:black;font-size:1rem;font-weight: bold;">Tarjeta de Crédito</div>';
                            echo '<div class="col-6" style="text-align:right;"><img src="../img/visa.png" style="height:20px;">&nbsp;&nbsp;<img src="../img/mastercard.png" style="height:20px;"></div>';
                        }else{
                            echo '<div class="col-6" style="color:black;font-size:1rem;font-weight: bold;">Tarjeta de Débito</div>';
                            echo '<div class="col-6" style="text-align:right;"><img src="../img/visa.png" style="height:20px;">&nbsp;&nbsp;<img src="../img/mastercard.png" style="height:20px;"></div>';
                        }
                    ?>
                    </div>
                    <h6 style="text-align:center;font-size: 0.9rem;">Autorización de pago</h6>
                    <div style="font-weight: bolder;border-radius: 5px;width:80%; padding:10px;font-size:1.2rem;color:black;text-align:center;margin:15px auto;"><?php echo $order->charges[0]->payment_method->auth_code;?></div>
                    ...
                    <div id="costo-total">
                        <div class="row" style="padding-top:15px;padding-bottom: 15px;">
                            ...
                            <div class="col-5 derecha">$<?php echo $rowPedido['total']." MXM";?></div>
                            <!-- <div class="col-5 derecha">$<?php echo number_format($order->amount/100,2)."".$order->currency;?></div> -->
                            <div class="col-1"></div>
                        </div>
                    </div>
                </div>
