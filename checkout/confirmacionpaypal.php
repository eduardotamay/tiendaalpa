        ...
        <div class="row" style="margin-top:20px; margin-bottom:80px;color:#666;">
            ...
            <div class="col-md-4">
                <div class="caja-blanca sticky-top" style="top:100px;">
                    ...
                    <hr>
                    <div class="row" style="margin-bottom:20px;">
                        <div class="col-6" style="color:black;font-size:1rem;font-weight: bold;">Paypal</div>
                        <div class="col-6" style="text-align:right;"><img src="../img/paypal.png" style="height:20px;"></div>
                    </div>
