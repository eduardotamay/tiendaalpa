            ...
            echo'<div id="categorie-'.$precio_fi.'" class="row item-resultado">
                    <div class="col-sm-4">
                        <a href="detalles.php?producto='.$resultados->datos[$i]['sku'].'">
                            <div class="row ajusta-margen">
                                <div class="col-sm-3"><img class="imagen-resultado" src="img/productos/ejemplo.png"></div>
                                <div class="col-sm-9">
                                    ...
                                    <div style="display:inline-flex">
                                        <div style="font-size:0.7rem;color:#777; padding-top:4px;padding-right:10px;">SKU: <span id="pal" style="font-weight:bolder;">'.$resultados->datos[$i]['sku'].'</span></div>
                    ...
                    <div class="col-sm-5">
                        <div class="row ajusta-margen">
                            ...
                            <div class="col-4 centra">
                                <select class="form-control resultado-cantidad" id="resultado1">
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3</option>
                                    <option>4</option>
                            ...
                            <div class="col-4 centra">
                                <a class="btn btn-primary btn-sm resultado-agregar" href="detalles.php?producto='.$resultados->datos[$i]['sku'].'" role="button">Agregar a carrito</a>
                            </div>
                        </div>
                    </div>
                </div>';
